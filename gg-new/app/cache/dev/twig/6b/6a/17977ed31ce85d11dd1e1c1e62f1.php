...
class __TwigTemplate_6b6a17977ed31ce85d11dd1e1c1e62f1 extends Twig_Template
{
    ...
    <div class=\"block_exception\">
        ...
        echo "\"/>
                ...
                <h1>
                    ";
        // line 15
        echo $this->env->getExtension('code')->formatFileFromText(nl2br(twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "exception"), "message"), "html", null, true)));
        echo "
                </h1>
        ...
        echo " - ";
        echo $this->env->getExtension('code')->abbrClass(twig_template_get_attributes($this, $this->getContext($context, "exception"), "class"));
        echo "
                </div>

                ";
        // line 22
        $context["previous_count"] = twig_length_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "exception"), "allPrevious"));
        // line 23
        echo "                ";
        if ($this->getContext($context, "previous_count")) {
            ...
            $context['_seq'] = twig_ensure_traversable(twig_template_get_attributes($this, $this->getContext($context, "exception"), "allPrevious"));
            foreach ($context['_seq'] as $context["i"] => $context["previous"]) {
                // line 27
                echo "                                <li>
                                    ";
                // line 28
                echo $this->env->getExtension('code')->abbrClass(twig_template_get_attributes($this, $this->getContext($context, "previous"), "class"));
    ...
    ";
        // line 43
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(twig_template_get_attributes($this, $this->getContext($context, "exception"), "toarray"));
    ...
    ";
        ...
        if ($this->getContext($context, "logger")) {
            ...
            echo "
                ";
            // line 60
            if (twig_template_get_attributes($this, $this->getContext($context, "logger"), "counterrors")) {
                // line 61
                echo "                    <div class=\"error_count\">
                        <span>
                            ";
                // line 63
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "logger"), "counterrors"), "html", null, true);
                echo " error";
                echo (((twig_template_get_attributes($this, $this->getContext($context, "logger"), "counterrors") > 1)) ? ("s") : (""));
                echo "
                        </span>
                    </div>
                ";
            ...
            <div id=\"logs\">
                ";
            // line 71
            $this->env->loadTemplate("TwigBundle:Exception:logs.html.twig")->display(array("logs" => twig_template_get_attributes($this, $this->getContext($context, "logger"), "logs")));
            // line 72
            echo "            </div>
