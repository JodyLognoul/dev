...
class __TwigTemplate_719e36ab9ca010a7bd735bd4b143098c extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        // line 4
        echo "    ";
        if (twig_template_get_attributes($this, $this->getContext($context, "collector"), "counterrors")) {
            // line 5
            echo "        ";
            ob_start();
            // line 6
            ...
            // line 7
            echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "collector"), "counterrors"), "html", null, true);
            echo "</span>
        ";
...
";
    ...
    ";
        // line 34
        $context["priority"] = twig_template_get_attributes($this, twig_template_get_attributes($this, twig_template_get_attributes($this, $this->getContext($context, "app"), "request"), "query"), "get", array(0 => "priority", 1 => 0), "method");
        // line 35
        echo "
    <table>
        <tr>
    ...
    ";
        // line 56
        if (twig_template_get_attributes($this, $this->getContext($context, "collector"), "logs")) {
            // line 57
            echo "        <ul class=\"alt\">
            ";
            // line 58
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable(twig_template_get_attributes($this, $this->getContext($context, "collector"), "logs"));
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["log"]) {
                if ((twig_template_get_attributes($this, $this->getContext($context, "log"), "priority") >= $this->getContext($context, "priority"))) {
                    // line 59
                    echo "                <li class=\"";
                    echo twig_escape_filter($this->env, twig_cycle(array(0 => "odd", 1 => "even"), twig_template_get_attributes($this, $this->getContext($context, "loop"), "index")), "html", null, true);
                    if ((twig_template_get_attributes($this, $this->getContext($context, "log"), "priority") >= 400)) {
                        echo " error";
                    } elseif ((twig_template_get_attributes($this, $this->getContext($context, "log"), "priority") >= 300)) {
                        echo " warning";
                    }
                    echo "\">
                    ";
                    // line 60
                    echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "log"), "priorityName"), "html", null, true);
                    echo " - ";
                    echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "log"), "message"), "html", null, true);
                    echo "
                    ";
                    // line 61
                    if ((twig_template_get_attributes($this, $this->getContext($context, "log", true), "context", array(), "any", true, true) && (!twig_test_empty(twig_template_get_attributes($this, $this->getContext($context, "log"), "context"))))) {
                        // line 62
                        echo "                        <br />
                        <small>
                            <strong>Context</strong>: ";
                        // line 64
                        echo twig_escape_filter($this->env, $this->env->getExtension('yaml')->encode(twig_template_get_attributes($this, $this->getContext($context, "log"), "context")), "html", null, true);
                        echo "
                        </small>
                    ";
                    }
