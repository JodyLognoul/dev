...
class __TwigTemplate_088704e6ae11b19c0d6517356e99e8fd extends Twig_Template
{
...
";
    ...
    <span class=\"count\">
        ";
        // line 13
        if (twig_template_get_attributes($this, $this->getContext($context, "collector"), "hasexception")) {
            // line 14
            echo "            <span>1</span>
        ";
        }
...
";
    ...
    ";
            ...
            // line 28
            echo "        ";
            echo $this->env->getExtension('actions')->renderAction("WebProfilerBundle:Exception:show", array("exception" => twig_template_get_attributes($this, $this->getContext($context, "collector"), "exception"), "format" => "html"), array());
            // line 29
            echo "    ";
        }
    }
