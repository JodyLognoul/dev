...
class __TwigTemplate_bb819bf00c377f085ea2a67005b314e4 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        // line 4
        echo "    ";
        if (twig_template_get_attributes($this, $this->getContext($context, "collector"), "messagecount")) {
            // line 5
            echo "        ";
            ob_start();
            // line 6
            ...
            // line 7
            echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "collector"), "messageCount"), "html", null, true);
            echo "</span>
        ";
            ...
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span>";
            // line 16
            echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "isSpool")) ? ("yes") : ("no"));
            echo "</span>
            </div>
        ";
...
";
    ...
    public function block_panel($context, array $blocks = array())
    {
        // line 34
        echo "    <h2>Messages ";
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "isSpool")) ? ("spooled") : ("sent"));
        echo "</h2>

    ";
        // line 36
        if ((!twig_template_get_attributes($this, $this->getContext($context, "collector"), "messages"))) {
            // line 37
            echo "        <p>
    ...
    ";
            ...
            $context['_seq'] = twig_ensure_traversable(twig_template_get_attributes($this, $this->getContext($context, "collector"), "messages"));
            ...
            ";
                // line 44
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable(twig_template_get_attributes($this, twig_template_get_attributes($this, $this->getContext($context, "message"), "headers"), "all"));
            ...
            <p>
                <pre>";
                // line 50
                if (twig_template_get_attributes($this, $this->getContext($context, "message"), "charset")) {
                    // line 51
                    echo twig_escape_filter($this->env, twig_convert_encoding(twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "message"), "body"), "html", twig_template_get_attributes($this, $this->getContext($context, "message"), "charset")), "UTF-8", twig_template_get_attributes($this, $this->getContext($context, "message"), "charset")), "html", null, true);
                } else {
                    // line 53
                    echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "message"), "body"), "html");
                }
                // line 55
                echo "</pre>
            </p>
