...
class __TwigTemplate_78769991dd1d38f4683ab10aeb306851 extends Twig_Template
{
...
";
    ...
    public function block_form_widget_compound($context, array $blocks = array())
    {
        ...
        ";
        // line 23
        if (twig_test_empty(twig_template_get_attributes($this, $this->getContext($context, "form"), "parent"))) {
            // line 24
            echo "            ";
...
";
    ...
    public function block_choice_widget_options($context, array $blocks = array())
    {
        ...
        ";
                ...
                // line 96
                echo "            <option value=\"";
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "choice"), "value"), "html", null, true);
                echo "\"";
                if ($this->env->getExtension('form')->isSelectedChoice($this->getContext($context, "choice"), $this->getContext($context, "value"))) {
                    echo " selected=\"selected\"";
                }
                echo ">";
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans(twig_template_get_attributes($this, $this->getContext($context, "choice"), "label"), array(), $this->getContext($context, "translation_domain")), "html", null, true);
                echo "</option>
        ";
            }
            // line 98
...
";
    ...
    ";
            ...
            ";
            // line 120
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "date"), 'errors');
            echo "
            ";
            // line 121
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "time"), 'errors');
            echo "
            ";
            // line 122
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "date"), 'widget');
            echo "
            ";
            // line 123
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "time"), 'widget');
            echo "
        </div>
    ";
        }
...
$this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "year"), 'widget'), "{{ month }}" =>             // line 137
$this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "month"), 'widget'), "{{ day }}" =>             // line 138
$this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "day"), 'widget')));
            // line 139
            echo "
        </div>
    ";
    ...
    ";
            ...
            ";
            // line 151
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "hour"), 'widget', array("attr" => array("size" => "1")));
            echo ":";
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "minute"), 'widget', array("attr" => array("size" => "1")));
            if ($this->getContext($context, "with_seconds")) {
                echo ":";
                echo $this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, $this->getContext($context, "form"), "second"), 'widget', array("attr" => array("size" => "1")));
            }
            // line 152
            echo "        </div>
    ";
...
";
    ...
    public function block_form_label($context, array $blocks = array())
    {
        ...
        if ($this->getContext($context, "required")) {
            // line 228
            echo "        ";
            $context["label_attr"] = twig_array_merge($this->getContext($context, "label_attr"), array("class" => trim((((twig_template_get_attributes($this, $this->getContext($context, "label_attr", true), "class", array(), "any", true, true)) ? (_twig_default_filter(twig_template_get_attributes($this, $this->getContext($context, "label_attr", true), "class"), "")) : ("")) . " required"))));
            // line 229
            echo "    ";
        }
        // line 230
...
";
    ...
    public function block_form_errors($context, array $blocks = array())
    {
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
                // line 276
                echo "            <li>";
                echo twig_escape_filter($this->env, (((null === twig_template_get_attributes($this, $this->getContext($context, "error"), "messagePluralization"))) ? ($this->env->getExtension('translator')->trans(twig_template_get_attributes($this, $this->getContext($context, "error"), "messageTemplate"), twig_template_get_attributes($this, $this->getContext($context, "error"), "messageParameters"), "validators")) : ($this->env->getExtension('translator')->transchoice(twig_template_get_attributes($this, $this->getContext($context, "error"), "messageTemplate"), twig_template_get_attributes($this, $this->getContext($context, "error"), "messagePluralization"), twig_template_get_attributes($this, $this->getContext($context, "error"), "messageParameters"), "validators"))), "html", null, true);
                // line 280
                echo "</li>
        ";
            }
    ...
    public function block_form_rest($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            // line 290
            echo "        ";
            if ((!twig_template_get_attributes($this, $this->getContext($context, "child"), "rendered"))) {
                // line 291
                echo "            ";
