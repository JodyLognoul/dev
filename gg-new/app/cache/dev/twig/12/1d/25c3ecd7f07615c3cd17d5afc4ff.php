...
class __TwigTemplate_121d25c3ecd7f07615c3cd17d5afc4ff extends Twig_Template
{
    ...
    <div id=\"content\">
        ...
        if ($this->getContext($context, "profile")) {
            ...
            echo "\">View all</a>
                            ...
                            ";
            // line 18
            echo twig_escape_filter($this->env, twig_upper_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "profile"), "method")), "html", null, true);
            echo "
                            ";
            // line 19
            if (twig_in_filter(twig_upper_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "profile"), "method")), array(0 => "GET", 1 => "HEAD"))) {
                // line 20
                echo "                                <a href=\"";
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "profile"), "url"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "profile"), "url"), "html", null, true);
                echo "</a>
                            ";
            ...
            echo "                            <span class=\"date\">
                                <em>by ";
            // line 25
            echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "profile"), "ip"), "html", null, true);
            echo "</em> at <em>";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "profile"), "time"), "r"), "html", null, true);
            echo "</em>
                            </span>
                        </div>
                    ";
        ...
        if (array_key_exists("templates", $context)) {
            ...
            foreach ($context['_seq'] as $context["name"] => $context["template"]) {
                ...
                echo "                                ";
                ob_start();
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "template"), "renderBlock", array(0 => "menu", 1 => array("collector" => twig_template_get_attributes($this, $this->getContext($context, "profile"), "getcollector", array(0 => $this->getContext($context, "name")), "method"))), "method"), "html", null, true);
