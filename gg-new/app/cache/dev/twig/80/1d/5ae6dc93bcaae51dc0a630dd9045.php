...
class __TwigTemplate_801d5ae6dc93bcaae51dc0a630dd9045 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        // line 4
        echo "    ";
        if (twig_template_get_attributes($this, $this->getContext($context, "collector"), "user")) {
            // line 5
            echo "        ";
            $context["color_code"] = (((twig_template_get_attributes($this, $this->getContext($context, "collector"), "enabled") && twig_template_get_attributes($this, $this->getContext($context, "collector"), "authenticated"))) ? ("green") : ("yellow"));
            // line 6
            echo "        ";
            $context["authentication_color_code"] = (((twig_template_get_attributes($this, $this->getContext($context, "collector"), "enabled") && twig_template_get_attributes($this, $this->getContext($context, "collector"), "authenticated"))) ? ("green") : ("red"));
            // line 7
            echo "        ";
            $context["authentication_color_text"] = (((twig_template_get_attributes($this, $this->getContext($context, "collector"), "enabled") && twig_template_get_attributes($this, $this->getContext($context, "collector"), "authenticated"))) ? ("Yes") : ("No"));
            // line 8
            echo "    ";
        } else {
            // line 9
            echo "        ";
            $context["color_code"] = ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "enabled")) ? ("red") : ("black"));
            // line 10
            echo "    ";
        }
        // line 11
        ...
        if (twig_template_get_attributes($this, $this->getContext($context, "collector"), "user")) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "collector"), "user"), "html", null, true);
            echo "</span>
            </div>
        ...
        ";
        } elseif (twig_template_get_attributes($this, $this->getContext($context, "collector"), "enabled")) {
            // line 22
        ...
        if (twig_template_get_attributes($this, $this->getContext($context, "collector"), "user")) {
            ...
            <tr>
                ...
                <td>
                    ";
            // line 53
            if (twig_template_get_attributes($this, $this->getContext($context, "collector"), "authenticated")) {
                // line 54
                echo "                        yes
                    ";
            } else {
                // line 56
                echo "                        no ";
                if ((!twig_length_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "collector"), "roles")))) {
            ...
            <tr>
                ...
                <td>";
            // line 62
            echo twig_escape_filter($this->env, $this->env->getExtension('yaml')->encode(twig_template_get_attributes($this, $this->getContext($context, "collector"), "roles")), "html", null, true);
            echo "</td>
            </tr>
        </table>
    ";
