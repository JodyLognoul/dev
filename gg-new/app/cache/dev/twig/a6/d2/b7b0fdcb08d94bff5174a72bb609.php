...
class __TwigTemplate_a6d2b7b0fdcb08d94bff5174a72bb609 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        echo "        <a href=\"http://symfony.com/\">
            ...
            <span>";
        // line 8
        echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "collector"), "symfonyversion"), "html", null, true);
        echo "</span>
        </a>
    ";
    ...
    ";
        ...
        echo "            <div class=\"sf-toolbar-info-piece sf-toolbar-info-php\">
                ...
                <span>";
        // line 31
        echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "collector"), "phpversion"), "html", null, true);
        echo "</span>
            </div>
        ...
        // line 35
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "hasxdebug")) ? ("green") : ("red"));
        echo "\">xdebug</span>
                <span class=\"sf-toolbar-status sf-toolbar-status-";
        // line 36
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "hasaccelerator")) ? ("green") : ("red"));
        echo "\">accel</span>
            </div>
        ";
    ...
    ";
        ...
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "debug")) ? ("green") : ("red"));
        ...
        // line 49
        echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "collector"), "appname"), "html", null, true);
        echo "</span><span>";
        echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "collector"), "env"), "html", null, true);
        echo "</span>
        </span>
    ";
        $context["icon"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        ...
        echo twig_escape_filter($this->env, $this->getContext($context, "debug_status_class"), "html", null, true);
        echo "\">";
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "debug")) ? ("en") : ("dis"));
        echo "abled</span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                <b>Token</b>
        ...
        if ($this->getContext($context, "profiler_url")) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "collector"), "token"), "html", null, true);
            echo "</a>
                    ";
        } else {
            // line 72
...
";
    ...
    <table>
        ...
        <tr>
            ...
            <td>";
        // line 109
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "debug")) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td>";
        // line 125
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "hasxdebug")) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
            ...
            <td>";
        // line 129
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "hasaccelerator")) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
            <th>XCache</th>
            <td>";
        // line 133
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "hasxcache")) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
            <th>APC</th>
            <td>";
        // line 137
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "hasapc")) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
            <th>EAccelerator</th>
            <td>";
        // line 141
        echo ((twig_template_get_attributes($this, $this->getContext($context, "collector"), "haseaccelerator")) ? ("enabled") : ("disabled"));
        echo "</td>
        </tr>
        <tr>
    ...
    ";
        // line 149
        if (twig_template_get_attributes($this, $this->getContext($context, "collector"), "bundles")) {
            // line 150
        ...
        <table>
            ...
            ";
            // line 156
            $context["bundles"] = twig_template_get_attributes($this, $this->getContext($context, "collector"), "bundles");
            // line 157
            echo "            ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                <td>";
                // line 160
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $this->getContext($context, "bundles"), $this->getContext($context, "name"), array(), "array"), "html", null, true);
                echo "</td>
            </tr>
            ";
            }
