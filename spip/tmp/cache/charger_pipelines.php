...
$val = minipipe('breves_accueil_encours', $val);
return $val;
}
...
$val = minipipe('breves_accueil_informations', $val);
return $val;
}
...
$val = minipipe('petitions_afficher_config_objet', $val);
return $val;
}
...
$val = minipipe('breves_affiche_enfants', $val);
return $val;
}
...
$val = minipipe('organiseur_alertes_auteur', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'porte_plume/porte_plume_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'revisions/inc/revisions_autoriser.php');
...
$val = minipipe('svp_ajouter_onglets', $val);
return $val;
}
// Pipeline body_prive 
...
$val = minipipe('breves_calculer_rubriques', $val);
return $val;
}
...
$val = minipipe('organiseur_configurer_liste_metas', $val);
...
$val = minipipe('compresseur_declarer_filtres_squelettes', $val);
return $val;
}
...
$val = minipipe('cvtmulti_formulaire_charger', $val);
...
$val = minipipe('cvtmulti_formulaire_verifier', $val);
return $val;
}
...
$val = minipipe('jqueryui_header_prive_css', $val);
...
$val = minipipe('jqueryui_jquery_plugins', $val);
...
$val = minipipe('organiseur_lister_tables_noexport', $val);
return $val;
}
...
$val = minipipe('breves_rubrique_encours', $val);
return $val;
}
...
$val = minipipe('breves_trig_calculer_langues_rubriques', $val);
return $val;
}
...
$val = minipipe('forum_forum_objets_depuis_env', $val);
return $val;
}
...
$val = minipipe('mots_mots_indexation', $val);
return $val;
}
