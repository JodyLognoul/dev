...
. vide($Pile['vars'][(string)'restreints'] = plus(table_valeur($Pile["vars"], (string)'restreints', null),$Numrows['_artsr']['total'])) .
'
				');
	}
	lang_select();
...
'&nbsp;:
				' .
vide($Pile['vars'][(string)'restreints'] = '0') .
...
// Temps de compilation total: 6.903 ms
//
...
'<div class=\'accueil_informations articles liste\'>
	' .
vide($Pile['vars'][(string)'titre'] = array('prepa' => _T('public|spip|ecrire:texte_statut_en_cours_redaction'), 'prop' => _T('public|spip|ecrire:texte_statut_attente_validation'), 'publie' => _T('public|spip|ecrire:texte_statut_publies'))) .
'
' .
