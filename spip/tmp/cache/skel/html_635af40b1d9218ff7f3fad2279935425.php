...
// Temps de compilation total: 1.158 ms
//
...
(($t1 = strval(interdire_scripts(((entites_html(table_valeur(@$Pile[0], (string)'fermer', null),true)) ?'' :' '))))!=='' ?
		($t1 . (	'
' .
	vide($Pile['vars'][(string)'titre'] = _T('compagnon:c_accueil_bienvenue',array('nom' => interdire_scripts(invalideur_session($Cache, table_valeur($GLOBALS["visiteur_session"], (string)'nom', null)))))) .
	'
' .
