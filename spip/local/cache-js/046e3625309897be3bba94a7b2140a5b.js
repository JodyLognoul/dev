/* compact [
	...
	../plugins-dist/mediabox/javascript/jquery.colorbox.js?1346317952
	../plugins-dist/mediabox/javascript/spip.mediabox.js?1346317952
...
verifForm_clicked=false;if(!jQuery)return;if(!jQuery.browser.msie)
...
if(e.keyCode===9){if(shiftKey==true||ctrlKey==true||altKey==true){
return true;
}
if(caretOffset!==-1){
get();
...
.parent().find('.markItUpButton a').attr('tabindex',-1).end();
};
$.fn.barre_previsualisation=function(settings){
options={
previewParserPath:"index.php?action=porte_plume_previsu",textEditer:"Éditer",
textVoir:"Voir"
};
$.extend(options,settings);
return $(this)
...
.parent().find('.markItUpTabs a').attr('tabindex',-1).end();
};
